...
cp /usr/local/lib/librats/librats_lib.so.0.7.0 image/opt/occlum/glibc/lib
...
cp /usr/lib/x86_64-linux-gnu/libcbor.so.0.6 image/opt/occlum/glibc/lib
...
occlum build
occlum run /bin/rats-tls-server -l debug -m
