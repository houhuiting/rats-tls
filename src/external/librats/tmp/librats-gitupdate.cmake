...
execute_process(
  COMMAND "/usr/bin/git" show-ref 42e2d7df63aed8e08d40a13562b4e1573d7c6d8c
  WORKING_DIRECTORY "/root/hht/rats-tls/src/external/librats/src/librats"
...
if("${show_ref_output}" MATCHES "refs/remotes/42e2d7df63aed8e08d40a13562b4e1573d7c6d8c")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "42e2d7df63aed8e08d40a13562b4e1573d7c6d8c")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "42e2d7df63aed8e08d40a13562b4e1573d7c6d8c")
endif()

# This will fail if the tag does not exist (it probably has not been fetched
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 42e2d7df63aed8e08d40a13562b4e1573d7c6d8c
  WORKING_DIRECTORY "/root/hht/rats-tls/src/external/librats/src/librats"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/houhuiting/librats.git'")
  endif()
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/root/hht/rats-tls/src/external/librats/src/librats/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/root/hht/rats-tls/src/external/librats/src/librats/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
